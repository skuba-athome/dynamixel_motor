...
if __name__ == '__main__':
    ...
    pan = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','10'], stdout=subprocess.PIPE, env=env)
    ...
    tilt = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','11'], stdout=subprocess.PIPE, env=env)
    ...
    shd_in_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','20'], stdout=subprocess.PIPE, env=env)
    ...
    shd_out_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','21'], stdout=subprocess.PIPE, env=env)
    ...
    elb_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','22'], stdout=subprocess.PIPE, env=env)
    ...
    wst1_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','40'], stdout=subprocess.PIPE, env=env)
    ...
    wst2_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','41'], stdout=subprocess.PIPE, env=env)
    ...
    wst3_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','42'], stdout=subprocess.PIPE, env=env)
    ...
    grp_r = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','43'], stdout=subprocess.PIPE, env=env)
    ...
    shd_in_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','25'], stdout=subprocess.PIPE, env=env)
    ...
    shd_out_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','26'], stdout=subprocess.PIPE, env=env)
    ...
    elb_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','27'], stdout=subprocess.PIPE, env=env)
    ...
    wst1_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','45'], stdout=subprocess.PIPE, env=env)
    ...
    wst2_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','46'], stdout=subprocess.PIPE, env=env)
    ...
    wst3_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','47'], stdout=subprocess.PIPE, env=env)
    ...
    grp_l = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','48'], stdout=subprocess.PIPE, env=env)
    ...
    prism = subprocess.Popen(['python','info_dump.py','--port=/dev/ttyUSB0','--baud=57600','50'], stdout=subprocess.PIPE, env=env)
